...
{
    /// <summary>
    /// Represents a snapshot of the current model for the <see cref="AppDBContext"/>.
    /// This class is used by Entity Framework Core to keep track of the model's state
    /// and to generate migrations when the model changes.
    /// </summary>
    [DbContext(typeof(AppDBContext))]
    partial class AppDBContextModelSnapshot : ModelSnapshot
    {
        /// <summary>
        /// Builds the model for the current database context.
        /// This method is called by Entity Framework Core to define the schema,
        /// relationships, and seed data for the database.
        /// </summary>
        /// <param name="modelBuilder">The builder used to construct the model for the context.</param>
        protected override void BuildModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            // The following code is auto-generated by Entity Framework Core.
            // It defines the schema, relationships, and seed data for the database.
            modelBuilder
